          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              <ArgonTypography variant="h5" color="white" mb={0.5}>
                Karnataka State Goverment
              </ArgonTypography>
              <ArgonTypography variant="body2" color="white">
                State Board school teachers upset over cut in summer vacation
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
        <SwiperSlide>
          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              <ArgonTypography variant="body2" color="white">
                Only 15 days left for vehicle owners to get registration plates
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
        <SwiperSlide>
          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              <ArgonTypography variant="body2" color="white">
                IMD warns of heavy rainfall, issues Orange alert to Karnataka for 3 days
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
